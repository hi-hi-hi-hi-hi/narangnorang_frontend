<template>
    <div class="w-50 mx-auto text-center">
        ...
        <div v-if="type === 1">
            ...
            <div v-else-if="result < 21">
                <div>약간의 우울감</div>
            </div>
            <div v-else-if="result < 25">
                <div>심한 우울감</div>
            </div>
            <div v-else>
                <div>매우 심한 우울감</div>
...
export default {
    data () {
        return {
            ...
            result: Number(this.$route.params.result)
        }
    },
    computed: {
        getImgSrc () {
